...
public class JobResultAdapter extends RecyclerView.Adapter<BaseViewHolder>{
    private static final String TAG = "JobResultAdapter";
    ...
    public JobResultAdapter(Context context, ArrayList<JobInfo> data) {
        this.dataSet = data;
    ...
    public void addAll(List<JobInfo> postItems) {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        switch (viewType){
            ...
            case VIEW_TYPE_NORMAL:
                return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.card_job_result, parent, false));
            default:
                return null;
        }
    }
    ...
    public class ViewHolder extends BaseViewHolder {
        ...
        CardView cvChat, cvQuote, cvItem;
        TextView tvJobName, tvIndustry, tvPostedDate;
        ...
        public ViewHolder(View itemView) {
            ...
            this.cvQuote = itemView.findViewById(R.id.cv_quote);
        ...
        public void onBind(int position) {
            ...
            tvPostedDate.setText(TimeHelper.convertFrindlyTime(item.job_posted_date));
    ...
    public interface OnItemClickListener {
        void onTapChat(JobInfo item);
        void onTapQuote(JobInfo item);
        void onTapItem(JobInfo item);
    }
}
